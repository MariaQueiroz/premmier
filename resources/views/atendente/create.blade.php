            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Informe abaixo as informações do atendente
                        <a class="pull-right" href="{{ url('atendentes')}}">Listagem atendente</a>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        @if (Request::is('*/editar'))
                            {!! Form::model($atendente, ['method' => 'PATCH', 'url' => 'atendentes/'.$atendente->id]) !!}
                        @else
                            {!! Form::open(['url' => 'atendentes/salvar']) !!}
                        @endif
